...
function validate(mode){
    if(mode==='edit'){
        ...
        var contact_id=document.getElementById("id").textContent;
...
function popupdeleteContact(cont){ 
    ...
    document.getElementById('delete-contact').value=cont.value;
}
...
async function popupeditContact(cont){ 
    ...
    var edit = document.getElementById('edit-contact_id')
